...
// I need to create a variable to house my url for the fetch.


// I now must perform a fetch to ensure that everything is as it should be

    
    // const goFetch = "https://frontend-take-home.fetchrewards.com/form"
    // fetch(goFetch, {
    //     method:"POST",
    //     headers: {
